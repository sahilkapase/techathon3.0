      ...
      <div className="allcard">
        ...
        <div id="cardsec1" className="card-group" >
          <div className="card" id="card1">
            ...
            <div className="card-footer">
              <Link to="/Croprek" className="btn btn-primary">Check Now</Link>
            </div>
          </div>
          ...
          <div className="card" id="card2">
            ...
            <div className="card-footer">
              <Link to="/Diseasepre" className="btn btn-primary">Check Now</Link>
            </div>
          </div>
          ...
          <div className="card" id="card3">
            ...
            <div className="card-footer">
              <Link to="/SchemesMain" className="btn btn-primary">Check Now</Link>
            </div>
          </div>
        </div>
        ...
        <div id="cardsec2" className="card-group" >
          <div className="card" id="card4">
            ...
            <div className="card-footer">
              <Link to="/Weatherdetails" className="btn btn-primary">Check Now</Link>
            </div>
          </div>
          ...
          <div className="card" id="card5">
            ...
            <div className="card-footer">
              <Link to="/ExpertTalk" className="btn btn-primary">Check Now</Link>
            </div>
          </div>
          ...
          <div className="card" id="card6">
            ...
            <div className="card-footer">
              <Link to="/chatbot" className="btn btn-primary">Check Now</Link>
            </div>
          </div>
        </div>
      </div>
