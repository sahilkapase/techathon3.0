        ...
        <div className="profile-header-card">
          <div className="profile-header-content">
            ...
            <div className="profile-info-section">
              <h1 className="farmer-name">{JSON.parse(auth).Name}</h1>
              <div className="farmer-id-container">
                <span className="farmer-id-label">Farmer ID:</span>
                <span className="farmer-id-value">{JSON.parse(auth).Farmerid}</span>
                <button 
                  className="copy-btn"
              ...
              <div className="profile-stats">
                ...
                <div className="stat-item">
                  ...
                  <span className="stat-value">{JSON.parse(auth).Farmertype}</span>
                </div>
                <div className="stat-item">
                  <span className="stat-label">Gender:</span>
                  <span className="stat-value">{JSON.parse(auth).Gender}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="profile-details-table">
            <table id="F_Account_Pinfo" className="details-table">
                    <tr>
                      <th>Farmertype</th>
