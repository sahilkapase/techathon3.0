  ...
  onEmailSubmit(e) {
    ...
    fetch(`http://127.0.0.1:5000/verify/${Email}`, {
      ...
      .then((data) => {
        ...
        otpglobal = data.OTP;  // Fixed: Changed from data.otp to data.OTP to match FastAPI response
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="Compdivsignup">
              ...
              >
                ...
                {Districtdata.map((getst, index) => {
                  return <option key={index}>{getst}</option>;
                })}
              </select>
            </div>
            <div className="Compdivsignup">
