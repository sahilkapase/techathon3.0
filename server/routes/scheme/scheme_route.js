...
// Enhanced scheme features
router.get('/enhanced/eligible/:farmerid', scheme_controller.enhancedEligibleSchemes);
router.get('/insurance/:Schemeid', scheme_controller.getInsuranceOptions);
router.get('/simplified/:Schemeid', scheme_controller.getSimplifiedExplanation);
router.post('/reminders/send', scheme_controller.sendDeadlineReminders);
